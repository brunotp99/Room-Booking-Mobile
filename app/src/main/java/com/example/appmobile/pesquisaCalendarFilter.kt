...
class pesquisaCalendarFilter : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pesquisa_calendar_filter)
                ...
                getReservas(object: VolleyCallBack {
                    override fun onSuccess() {
                        ...
                        if(bundle != null){
                            ...
                            addComposeView(data!!, listSalas[0].nsala.toString(), listSalas[0].alocacao.toString(), listSalas[0].lugares.toString(), listSalas[0].intervalolimpeza.toString())
                        }
                    }
                    override fun onFailure(error: String) {
                        Log.i("PesquisaCalendar", error)
                    }
                })
            }
            override fun onFailure(error: String) {
    ...
    /* Obter lista de reservas da backend */
    ...
    /* Carregar calendario atraves do JetPack Compose */
